...
//    강의 추가
    ...
    public void insertTest(){
        ...
        lectureVO.create("모두의 깃 & 깃허브", "프로그래밍", "개발자의 필수 교양이라 할 수 있는 깃을 명령어 없이, 명령어로 다루는 방법과 깃허브를 능수능란하게 다루는 방법을 배웁니다.",
                "2022-12-20", Long.parseLong("18"), "Time B (13:00~17:00)","진행예정");
        lectureMapper.insert(lectureVO);
        log.info("number: " + lectureVO.getLectureNumber());
        log.info("title: " + lectureVO.getLectureTitle());
        log.info("category: " + lectureVO.getLectureCategory());
    }
